...
static dmb_ext_dev dmb_pmic_gpio;
dmb_ext_dev *get_dmb_pmic_data(void)
{
  return &dmb_pmic_gpio;
}
#else
#include <mach/irqs.h>
...
#ifdef TDMB_EN
  GPIO_CFG(TDMB_EN, 0, GPIO_CFG_OUTPUT, GPIO_CFG_NO_PULL, GPIO_CFG_2MA),
#endif
...
#if defined(CONFIG_ARCH_MSM8974)
static struct clk *xo_handle_a2 = NULL;

...
/////////////////////////////////////////////////////////////////////////
#elif defined(CONFIG_MACH_MSM8974_EF59S)||defined(CONFIG_MACH_MSM8974_EF59L) ||defined(CONFIG_MACH_MSM8974_EF59K)
  #define FEATURE_DMB_USE_DTS //CONFIG_ARCH_MSM8974
  #define DMB_RESET     58
  #define DMB_INT       92
  #define DMB_PWR_EN    91
#if (CONFIG_BOARD_VER <CONFIG_WS20)   /*13.07.09 SN*/
  #define FEATURE_DMB_PMIC_GPIO  900
  #define DMB_PMIC_GPIO_NUM  1
  #define DMB_ANT_SEL    (30+FEATURE_DMB_PMIC_GPIO)
...
/////////////////////////////////////////////////////////////////////////
#elif defined(CONFIG_MACH_MSM8974_EF56S)||defined(CONFIG_MACH_MSM8974_EF58L) || defined (CONFIG_MACH_MSM8974_NAMI)
  #define FEATURE_DMB_USE_DTS //CONFIG_ARCH_MSM8974
    //#define DMB_RESET     38
  #define DMB_INT       92
...
#else
  #define DMB_PWR_EN    91
#endif  /* CONFIG_SKY_TDMB_INC_BB_T3900 */
  //#define DMB_ANT_SEL    68
  //#define DMB_ANT_EAR_ACT   0
  //#define DMB_ANT_EAR_ACT2  1
  //#define FEATURE_DMB_SET_ANT_PATH
  //#define FEATURE_DMB_SET_ANT_PATH_POWER
#if (CONFIG_BOARD_VER > CONFIG_WS20)  
   #define TDMB_EN		58 // jgjun  
#else   
  #define FEATURE_DMB_PMIC_POWER //wgon test
  #define FEATURE_DMB_PMIC8921
#endif  
  #define FEATURE_DMB_GPIO_INIT
  #define FEATURE_DMB_THREAD

...
#if !(defined(CONFIG_MACH_MSM8974_EF60S) || defined(CONFIG_MACH_MSM8974_EF61K) || defined(CONFIG_MACH_MSM8974_EF62L) || defined(CONFIG_MACH_MSM8974_EF63S) || defined(CONFIG_MACH_MSM8974_EF63K) || defined(CONFIG_MACH_MSM8974_EF63L))  //p11774 blocked for HallIC 
	{
		.gpio = 65,
		.settings = {
...
#elif defined(CONFIG_MACH_MSM8974_EF59S) ||defined(CONFIG_MACH_MSM8974_EF59K) || defined(CONFIG_MACH_MSM8974_EF59L) || defined(CONFIG_MACH_MSM8974_EF60S) || defined(CONFIG_MACH_MSM8974_EF61K) || defined(CONFIG_MACH_MSM8974_EF62L)
static struct msm_gpiomux_config msm8974_sleep_gpio_gpio_configs[] __initdata = {
#if (defined (CONFIG_MACH_MSM8974_EF60S) && (CONFIG_BOARD_VER == CONFIG_PT10)) || (defined (CONFIG_MACH_MSM8974_EF61K) && (CONFIG_BOARD_VER == CONFIG_PT10)) || (defined (CONFIG_MACH_MSM8974_EF62L) && (CONFIG_BOARD_VER == CONFIG_PT10))
	{
		.gpio = 8,	
		.settings = {
			[GPIOMUX_ACTIVE]    = &msm8974_gpio_suspend_in_pd_cfg,
...
}; /* CONFIG_MACH_MSM8974_EF59S || CONFIG_MACH_MSM8974_EF59K || CONFIG_MACH_MSM8974_EF59L || CONFIG_MACH_MSM8974_EF60S || CONFIG_MACH_MSM8974_EF61K || CONFIG_MACH_MSM8974_EF62L*/
